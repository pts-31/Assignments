...
public class TrainTemplate extends Mode{

	//Implementation of the methods accordingly when mode of transport is chosen as train
	...
	public void getPassengerDetails(Integer number) {
		// TODO Auto-generated method stub
		System.out.println("There are "+number+" passengers travelling together in a train");
	}
	...
	public void getJourneyDate(Date date) {
		// TODO Auto-generated method stub
		System.out.println("The passenger in travelling in a train on "+date);
	}
